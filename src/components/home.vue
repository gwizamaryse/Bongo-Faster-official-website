  ...
  <v-flex xs12>
    <v-card   
      ...
      <v-layout row wrap>
           <v-flex xs7> 
              <v-card-text  > 
                <h1 class="mb-2 display-4 text-xs-center"  >BONGO 
                     </br> FASTER </h1>
                 <p class="title text-sm-center" >
                  UDART Mobile App: Mwendokasi on your hands
                 </p>
              </v-card-text>
           </v-flex>

            <v-flex offset xs5 md2>
             <v-img src="/lib/img/hand-1.png"> 
               </v-img>
            </v-flex> 
      </v-layout> 
     </v-card>
             ...
             <v-flex xs6 >
              ...
              <v-container fluid>
                  <v-content>
                    ...
                    <v-card-text>
                         <strong> know the route status </br>
                       Get bus schedule </br>
                          Your nearest Station </strong>
                            </v-card-text>
                           <v-flex >
                              <v-img 
          ...
          <v-flex xs6 >
            ...
            <v-card 
                   ...
                   class="white--text">
                     ...
                     <v-flex>
                         <v-card-title primary-title class="layout justify-center">
                           <div class="headline">Get Route Information,
                           </br> Know station locations, 
                            </br> Get Bus Location, Plan Your Trip</div>
                        </v-card-title>

                            <v-card-text  >
                              <strong> No reason to miss the bus </br>
                                 No reason to be late </strong>
                             </v-card-text>
                      </v-flex>
        ...
        <v-flex xs6 >
          <v-card 
            ...
            <v-flex xs6 >
              ...
              height="420px">
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline">Get News Updates, Safety tips, </br> guides and share </div>
                </v-card-title>
                <v-card-text  >
...
<!-- 4th block, how to use bongo Faster -->
            ...
            <v-flex xs12 >
              ...
              >
                ...
                <v-card-text  >
                  <strong> Simple | Multilingual | Faster </strong>
                </v-card-text>
              </v-card>
            </v-flex>
            ...
            <v-layout justify-center row wrap>
               <v-btn v-for="link in links"  :key="link" flat round >
                ...
                <v-flex py-3 text-xs-center xs12>
                   <strong>Copyright &copy;BongoFaster. All rights reserved.</strong> 
                 </v-flex>
             </v-layout>
          </v-footer>
        </v-flex>
...
.canbe--icon.app-store{
	background-image: url('/lib/img/it/r2-app-store.png');
	width: 170px;
	height: 51px;
}
.canbe--icon.google-play{
	background-image: url('/lib/img/it/r2-google-play.png');
	width: 170px;
	height: 56px;
}
</style>
