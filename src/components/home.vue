...
<div id = "app">
 <v-app id="light">
   ...
   <v-card tile class="yellow black--text" > 

      <v-card-text  > 
        <h1 class="text-sm-left"   >Bongo Faster</h1>
        <p class="text-sm-left" >
         UDART Mobile App: Mwendokasi on your hands
        </p>
      </v-card-text>

      <v-flex  offset-sm8 md2>
...
<!-- second block -->
            ...
            <v-flex xs6 >
              ...
              tile >
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline">Get Route Information,</br> Know station locations, </br> Get Bus Location, Plan Your Trip</div>
                </v-card-title>
                <v-card-text  >
        ...
        <v-flex xs6 >
              <v-card color=purple class="elevation-0 transparent"
            ...
            <v-flex xs6 >
              ...
              tile >
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline">Get News Updates, Safety tips, guides and share </br> Know station locations, </br> Get Bus Location, Plan Your Trip</div>
                </v-card-title>
                <v-card-text  >
                  Get notification from UDART on time </br>
                  Any changes on routes schedule, new routes information
                </v-card-text>
              </v-card>
            </v-flex>
            ...
            <v-layout justify-center row wrap>
               <v-btn v-for="link in links"  :key="link" flat round >
                ...
                <v-flex py-3 text-xs-center xs12>
                    Copyright &copy;BongoFaster. All rights reserved.
                 </v-flex>
             </v-layout>
          </v-footer>
        </v-flex>
